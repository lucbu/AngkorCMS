<?php namespace AngkorCMS\Medias\Commands;
use Illuminate\Console\Command;
use Illuminate\Container\Container;

class AngkorCMSMediasInstallCommand extends Command
{
    /**
     * Name of the command.
     * 
     * @param string
     */
    protected $name = 'angkorcmsmedias:install';
     ...
     * @param string
     */
    protected $description = 'Install angkorcms medias.';
